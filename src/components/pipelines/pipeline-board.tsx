...
function StageColumn({
  ...
  return (
    ...
    <div className="flex w-[85vw] min-w-[260px] max-w-[320px] shrink-0 snap-start flex-col rounded-xl border border-border bg-white p-4 shadow-sm lg:w-auto lg:max-w-none lg:flex-1 lg:basis-[260px] lg:shrink lg:snap-none">
      ...
      <Button
        ...
        className="mt-3 w-full justify-start border border-dashed border-border bg-white text-muted-foreground hover:border-primary/30 hover:bg-primary/5 hover:text-primary"
      >
