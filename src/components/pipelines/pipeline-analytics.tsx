...
export function PipelineAnalytics({ stages, deals }: PipelineAnalyticsProps) {
  ...
  return (
    <TooltipProvider>
      <div className="grid grid-cols-2 gap-3 rounded-xl border border-border bg-white p-4 shadow-sm sm:grid-cols-3 xl:grid-cols-6">
        <Metric
          icon={<BarChart3 className="h-4 w-4 text-[#1e293b]" />}
          label="Total Deals"
        ...
        />
        <Metric
          icon={<Target className="h-4 w-4 text-[#1e293b]" />}
          label="Avg Deal Size"
