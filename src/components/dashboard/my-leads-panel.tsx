...
export function MyLeadsPanel({ data, loading }: MyLeadsPanelProps) {
  if (loading) {
    return (
      <div className="flex min-h-[200px] items-center justify-center rounded-xl border border-slate-800 bg-slate-900">
    ...
    <div className="rounded-xl border border-slate-800 bg-slate-900">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-800 px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="text-sm font-semibold text-white">My leads</h2>
        ...
        <div className="flex flex-wrap gap-2 text-xs">
          <Link
            ...
            className="rounded-full border border-slate-700 bg-slate-800 px-2.5 py-1 text-slate-300 hover:border-slate-600 hover:text-white"
          >
            ...
            return (
              <li key={item.id}>
                ...
                >
                  <div
                    className={cn(
                      "flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-slate-800",
