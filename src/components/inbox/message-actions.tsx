  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "absolute -top-3 z-10 flex h-8 items-center gap-0.5 rounded-full border border-border bg-popover px-1.5 shadow-lg transition-opacity",
      ...
      >
        <Popover open={pickerOpen} onOpenChange={setPickerOpen}>
          ...
          <PopoverContent
            className="flex w-auto flex-row gap-1 border-border bg-popover p-1.5"
            sideOffset={6}
          >
            {QUICK_EMOJIS.map((e) => (
              <button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full text-lg leading-none transition-transform hover:scale-125 hover:bg-muted"
