    ...
    <section className="space-y-4">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Pick the accent color used across the app. All themes use a
          clean white background — only the primary color (buttons, active
          nav, badges) changes. Saved to this device.
        </p>
      </div>
